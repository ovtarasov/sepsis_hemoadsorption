This folder contains separate `*.Rmd` notebooks for data processing and analysis in the current project. Please find short annotations for individual notebooks below.  
